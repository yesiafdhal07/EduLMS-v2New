...
async def run_test():
    ...
    try:
        ...
        # -> Clear the email and password inputs, then click the 'Akses Portal' submit button to attempt submission with empty fields and observe any required-field validation.
