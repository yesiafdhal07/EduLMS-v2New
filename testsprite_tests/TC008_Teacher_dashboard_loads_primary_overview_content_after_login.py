...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Masuk Portal' link to open the login page.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/div/div[2]/header/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Fill the email and password fields with the provided credentials and submit the login form (click the 'Akses Portal' button). After submit, check for redirect / dashboard and verify overview content.
        frame = context.pages[-1]
        # Input text
