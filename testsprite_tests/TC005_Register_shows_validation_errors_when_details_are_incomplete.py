...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with a unique email and submit the registration form to confirm that submission is blocked and a required-field validation error is shown.
