...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the provided username.
        ...
        # -> Open the student actions/details from the dashboard to view attendance status information (click the student action button).
        frame = context.pages[-1]
        # Click element
