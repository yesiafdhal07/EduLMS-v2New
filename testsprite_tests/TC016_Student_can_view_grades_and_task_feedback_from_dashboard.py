...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with yesiafdhal07@guru.sma.belajar.id.
        ...
        # -> Open the student's detail / grades view by clicking the action button for the student to verify grades and feedback.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/div/main/div/div/div[4]/div[2]/table/tbody/tr/td[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the student's action button (chevron) to open the full grades/feedback view and then verify that grades and task feedback are displayed.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div[2]/div/div/main/div/div/div[4]/div[2]/table/tbody/tr/td[4]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
