                ...
                <div className="flex flex-col items-center w-1/3 h-full justify-end">
                    ...
                    >
                        <div className="absolute bottom-4 left-0 right-0 text-center">
                            ...
                            <p className="text-slate-400 text-xs font-medium">{topThree[1]?.total_points} XP</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center w-1/3 h-full z-10 justify-end">
                    ...
                    >
                        <div className="absolute bottom-4 left-0 right-0 text-center">
                            ...
                            <p className="text-amber-100 text-sm font-medium">{topThree[0]?.total_points} XP</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center w-1/3 h-full justify-end">
                    ...
                    >
                         <div className="absolute bottom-4 left-0 right-0 text-center">
                            ...
                            <p className="text-orange-300 text-xs font-medium">{topThree[2]?.total_points} XP</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <p className={`text-sm font-bold ${entry.user_id === currentUserId ? 'text-indigo-300' : 'text-slate-300'}`}>
                                {entry.full_name}
                                {entry.user_id === currentUserId && <span className="text-[10px] ml-2 px-1.5 py-0.5 bg-indigo-500 text-white rounded-md">You</span>}
                            </p>
                        </div>
